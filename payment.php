...
if (isset($_POST['submit'])) {
    ...
    // Fetch data once
    $stmt = $conn->prepare("SELECT u.username, u.email, u.mobile, u.city, t.theater FROM user u INNER JOIN theater_show t ON u.username = ? WHERE t.show = ?");
    $stmt->bind_param("ss", $username, $show);
    $stmt->execute();
