...
(1, 'admin', 'darshan@gmail.com', 'admin', '1');
...
alter table feedback  add constraint foreign key(id) references 
customers(id) on update cascade on delete set null;

alter table feedback  add constraint foreign key(id) references 
add_movie(id) on update cascade on delete set null;
